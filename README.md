...
## Windows tips
Setting the host path for ```jenkins_home``` is a bit tricky on Windows systems. First of all, you probably need to share the drive where the folder lives and you [this resource explains how](https://rominirani.com/docker-on-windows-mounting-host-directories-d96f3f056a2c#.7ec1d330n). Then, you need to provide the path with forward slashes, for example ```c:/Users/myuser/android_jenkins_home:/var/jenkins_home```
